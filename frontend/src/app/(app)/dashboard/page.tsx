...
import { useDashboard, usePositions, usePipelineStatus, useStartPipeline } from "@/lib/api/hooks";
...
export default function DashboardPage() {
  ...
  const isRunning = statusData?.is_running || startPipeline.isPending;
    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={handleStart}
          disabled={isRunning}
          className="inline-flex items-center gap-2 rounded-md bg-accent px-4 py-2 text-sm font-semibold text-accent-foreground shadow-sm transition-colors hover:bg-accent/90 disabled:pointer-events-none disabled:opacity-50"
        >
